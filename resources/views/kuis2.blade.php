...
<head>
  ...
  <title>Quiz 2 " Arti Kesebangunan</title>
...
let kunci = [];
    ...
    //script import json
    xhttp.open("GET", "kuis2.json", true);
    xhttp.send();
      ...
      <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-fluid" id="awalan">
                <div class="row">
                    <h1 class="text-center mt-4" style="color:black;">Kuis 2 "Arti Kesebangunan" </h1>
                      ...
                      <div class="card" style="border-radius: 10px; border:5px solid #FFD93D;">
                          ...
                          <div class="lh-lg card-body pb-5" style="text-align: justify; font-family:cursive  17px;">
                              <ul>
                                  ...
                                  <li>Setelah menjawab semua soal silahkan klik submit agar mengetahui skor dari kuis 2</li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bag-kuis" id="soal-2" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <img src="img/L2.2.jpg" style="width:350px;" />
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-3" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.3.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-4" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.4.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-5" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.5.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-6" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.6.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-7" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.7.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-8" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.8.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-9" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.9.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-10" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L2.10.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        Apakah kamu yakin ingin menyelesaikan kuis 2?
                        </div>
                ...
                <center>
                    ...
                    <div class="card" style="border-radius:10px;border:4px solid #FFD93D;">
                        <div class="card-header text-center" style="border-bottom-width: 4px; border-bottom-color: #FFD93D;background-color: #2CD3E1; color:black;">
                          <h5>HASIL KUIS 2 "Arti Kesebangunan"</h5>
                        </div>
