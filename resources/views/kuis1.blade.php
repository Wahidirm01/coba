...
<head>
  ...
  <title>Quiz 1 " Hubungan Antar Sudut</title>
      ...
      <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-fluid" id="awalan">
                <div class="row">
                    <h1 class="text-center mt-4" style="color:black;">Kuis 1 "Hubungan Antar Sudut" </h1>
                      ...
                      <div class="card" style="border-radius: 10px; border:5px solid #FFD93D;">
                          ...
                          <div class="lh-lg card-body pb-5" style="text-align: justify; font-family:cursive  17px;">
                              <ul>
                                  ...
                                  <li>Soal berupa pilihan ganda sebanyak 10 soal</li>
                                  <li>Durasi waktu pengerjaan sebanyak 20 menit</li>
                                  <li>Setelah menjawab semua soal silahkan klik submit agar mengetahui skor dari kuis 1</li>
                          ...
                          <div class="card-body pb-3" style="text-align: justify; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: 17px;">
                            <form>
                              ...
                              <div class="text-center">
                                  <!-- <button type="button" class="btn btn-secondary bg-danger" button onclick="location.href= 'https://materi1sok.netlify.app/" style="width:160px;">Kembali ke Materi</button> -->
                                  <button type="button" class="btn btn-primary bg-success" style="width:160px;" onclick="lanjutsoal()">Mulai Kuis</button>
                              </div>
                            </form>
                          </div>
                      </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bag-kuis" id="soal-3" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.3.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-4" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.4.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-5" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.5.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-6" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.6.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-7" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.7.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-8" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.8.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-9" hidden>
                                        <div><p><img src="img/book1.png" style="width:25px;"/><b>&nbsp;Nomor&nbsp;<span id="nomornyanih"></span></b><br>Perhatikan posisi setiap pasangan sudut pada gambar di bawah ini!</p>
                                        </div>
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.9.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <div class="bag-kuis" id="soal-10" hidden>
                                        ...
                                        <div style="text-align: center;">
                                            <p><img src= "img/L1.10.jpg" style="width:350px;"/></p>
                                        </div>
                                        <div class="soallll scrollkonten">
                                            <p>
                                                <span id="soal">
                                    ...
                                    <!--Jawaban-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <button type="button" class="btn btn-success float-end text-white disabled">Selanjutnya <i class="fa-sharp fa-solid fa-forward-step"></i></button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="container mt-2">
                            <div class="timer text-center">
                                <h3>
                                    <span id="gwaktu"><img src= "img/timerkuis.png"" style='width:10%'></span> 
                                    <span id="waktutampil">20 : 00</span>
                                </h3>
                            ...
                            <div class="card shadow border-light">
                                ...
                                <br>
                                <p>Keterangan:</p>
                                <p><span class="btn p-1" style="background-color: red; color: white; width: 30%; border: 1px solid rgb(128, 128, 128);">kuning </span> = Belum terjawab</p>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        Apakah kamu yakin ingin menyelesaikan kuis 1?
                        </div>
                ...
                <center>
                    ...
                    <div class="card" style="border-radius:10px;border:4px solid #FFD93D;">
                        <div class="card-header text-center" style="border-bottom-width: 4px; border-bottom-color: #FFD93D;background-color: #2CD3E1; color:black;">
                          <h5>HASIL KUIS 1 "Hubungan Antar Sudut"</h5>
                        </div>
                        ...
                        <center>
                            <div id="ulang" class="mt-1" hidden>
                                <p style="font-weight: bold;color: black;">Yah nilai kurang dari KKM "70", silahkan pelajari materi kembali ya!<img src="../assets/pic/sad.gif" width="3%" height="3%"></img></p>
                                <a class="btn btn-success mt-1" href='/'>Kembali Ke Materi</a>
                            </div>
                            <div id="lulus" hidden>
                                <p style="font-weight: bold; color: black;">Yeay! Selamat Nilai kamu memenuhi KKM, Ayo pelajari materi selanjutnya <img src="../assets/pic/happy.gif" width="3%" height="3%"></p>
                                <a class="btn btn-success mt-2" href='/'>Materi Selanjutnya</a>
                            </div>
                        </center>
                </div>
            </div>
